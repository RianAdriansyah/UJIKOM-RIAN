...
<body>
    <div class="container">
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header">Tambah Data lab</div>
                    <div class="card-body">
                    <form action="{{ route('lab.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="hasil_lab" cols="30" rows="5" class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Keterangan</label>
                                <textarea name="ket" cols="30" rows="5" class="form-control"></textarea>
                            </div>
